...
class Vertice{
    ...
    public:
        ...
        // Adicionei todos os atributos extras na própria classe de Vértices.
        // Creio que existam soluções mais elegantes, porém para um momento inicial
        // decidi deixar desse momento.
        // Em uma implementação mais específica, adaptaria cada classe
        // para conter apenas a informação necessária para o Algoritmo,
        // mas como quis reutilizar tudo sem ter que aplicar muitas mudanças
        // deixei assim por hora.
        int cor;
