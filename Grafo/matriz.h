/*
    Definição de uma classe Básica para representar matrizes

    O código é uma adaptação de outra implementação que fiz
    para um trabalho da disciplina de POO I do BCC.
*/
