/*
    ...
    Obs. No caso, minha árvore considera a aresta (a,h) ao invés de (b,c)
    ambas de custo 8... Isso ocorre devido a disposição dos vértices e arestas
    na estrutura de dados, mas não altera o resultado do algoritmo que é
